...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabprog3-jordana

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trabprog3-jordana: ${OBJECTFILES}
...
${OBJECTDIR}/Artista.o: Artista.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Artista.o Artista.cpp

${OBJECTDIR}/Assinante.o: Assinante.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Assinante.o Assinante.cpp

${OBJECTDIR}/Midia.o: Midia.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Midia.o Midia.cpp

${OBJECTDIR}/Musica.o: Musica.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Musica.o Musica.cpp

${OBJECTDIR}/NumPunctPTBR.o: NumPunctPTBR.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NumPunctPTBR.o NumPunctPTBR.cpp

${OBJECTDIR}/NumberUtils.o: NumberUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NumberUtils.o NumberUtils.cpp
