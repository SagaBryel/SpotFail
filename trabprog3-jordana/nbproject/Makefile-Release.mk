...
${OBJECTDIR}/NumPunctPTBR.o: NumPunctPTBR.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NumPunctPTBR.o NumPunctPTBR.cpp

${OBJECTDIR}/NumberUtils.o: NumberUtils.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NumberUtils.o NumberUtils.cpp
...
${OBJECTDIR}/Podcast.o: Podcast.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Podcast.o Podcast.cpp

${OBJECTDIR}/Podcaster.o: Podcaster.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Podcaster.o Podcaster.cpp

${OBJECTDIR}/Produtor.o: Produtor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Produtor.o Produtor.cpp
